...
### `CompressMultipleItemsAsync` (行 410)
- **型**: `private async Task`
- **引数**:
...
### `AddDirectoryToDictionary` (行 551)
- **型**: `private void`
- **引数**:
